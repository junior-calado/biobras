export const translations = {
  pt: {
    ...
    contact: {
      ...
      info: {
        address: 'Endereço: Av. Principal, 1000 - São Paulo, SP',
        phone: 'Telefone: (11) 1234-5678',
        email: 'E-mail: contato@biobras.com',
      },
    },
    careers: {
      title: 'Carreiras',
  ...
  en: {
    ...
    contact: {
      ...
      info: {
        address: 'Address: Main Ave, 1000 - São Paulo, SP',
        phone: 'Phone: (11) 1234-5678',
        email: 'Email: contact@biobras.com',
      },
    },
    careers: {
      title: 'Careers',
  ...
  es: {
    ...
    contact: {
      ...
      info: {
        address: 'Dirección: Av. Principal, 1000 - São Paulo, SP',
        phone: 'Teléfono: (11) 1234-5678',
        email: 'Correo: contacto@biobras.com',
      },
    },
    careers: {
      title: 'Carreras',
